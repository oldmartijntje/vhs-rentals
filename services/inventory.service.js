...
import { deleteInventoryItemFromDatabase } from "../dao/inventory.dao.js";
...
export function deleteInventoryItem(inventory_id, callback) {
    deleteInventoryItemFromDatabase(inventory_id, callback);
}
